...
@pytest.mark.parametrize("transactions", "code", [(transactions,
...
def test_filter_by_currency(gen_filter_currency, transactions, code):
    assert filter_by_currency(gen_filter_currency, transactions) == code
